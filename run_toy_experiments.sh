...
CUDA_VISIBLE_DEVICES=4,5,6,7 TORCH_DISTRIBUTED_DEBUG=DETAIL NCCL_DEBUG=INFO torchrun --master_port=29506 --nproc_per_node=4 scripts/train.py configs_toy_token-img2token/baseline_pixmo-captions_llama3-8b_dinov2-large-336.yaml
