...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --master_port=29501 --nproc_per_node=4 scripts/train.py configs_toy_token-img2token/caption-prompt_1color-per-image.yaml
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port=29502 --nproc_per_node=4 scripts/train.py configs_toy_token-img2token/empty-prompt_1color-per-image.yaml
