...
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port=29506 --nproc_per_node=4 scripts/train.py configs_toy_token-img2token/baseline_pixmo-captions_qwen2-7b_vit-l-14-336.yaml
