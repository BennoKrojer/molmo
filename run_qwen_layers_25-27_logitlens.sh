...
# Define the LLM (qwen only) and vision encoders
LLMS=("qwen2-7b")
VISION_ENCODERS=("vit-l-14-336" "dinov2-large-336" "siglip" "openvision2-l-14-336")

# Define the layers to analyze - focusing on Qwen's final layers
LAYER_GROUPS=("25,26,27")
...
echo "=========================================="
echo "All Qwen combinations processed for layers 25-27!"
echo "=========================================="
