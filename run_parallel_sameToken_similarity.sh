...
#
# Computes cosine similarity of vision tokens across layers to layer 0
#
...
echo "========================================"
echo "PARALLEL Same-Token Similarity Analysis"
echo "Strategy: 8 independent single-GPU jobs"
echo "========================================"
echo ""

# Script path
SCRIPT="/home/nlp/users/bkroje/vl_embedding_spaces/third_party/molmo/scripts/analysis/sameToken_acrossLayers_similarity.py"
NUM_IMAGES=100

# Output dir
OUTPUT_DIR="analysis_results/sameToken_acrossLayers_similarity"
...
# Log directory
LOG_DIR="logs/parallel_sameToken_similarity_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
