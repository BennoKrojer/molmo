...
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port=29505 --nproc_per_node=4 scripts/train.py configs/baseline_pixmo-captions_olmo-7b_vit-l-14-336.yaml
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --master_port=29503 --nproc_per_node=4 scripts/train.py configs/rest/baseline_pixmo-captions_qwen2-7b_vit-l-14-336_seed10_unfreeze-llm.yaml

# Earlier ViT layers ablations (run sequentially)
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --master_port=29503 --nproc_per_node=4 scripts/train.py configs/rest/baseline_pixmo-captions_olmo-7b_vit-l-14-336_earlier-vit-layers-6.yaml
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --master_port=29503 --nproc_per_node=4 scripts/train.py configs/rest/baseline_pixmo-captions_olmo-7b_vit-l-14-336_earlier-vit-layers-10.yaml
