#!/usr/bin/env python3
"""
LatentLens (Contextual Nearest Neighbors) for LLaVA-NeXT-34B across all layers.

Usage:
    CUDA_VISIBLE_DEVICES=0 python scripts/analysis/llava_next/contextual_nearest_neighbors_allLayers_singleGPU.py \
...
def main():
    parser = argparse.ArgumentParser(description="LatentLens for LLaVA-NeXT-34B")
    parser.add_argument("--contextual-dir", type=str, required=True)
    parser.add_argument("--visual-layer", type=str, default="0,1,2,4,8,16,30,45,58,59")
    parser.add_argument("--num-images", type=int, default=100)
    parser.add_argument("--split", type=str, default="validation")
    parser.add_argument("--top-k", type=int, default=5)
    parser.add_argument("--output-dir", type=str,
                       default="analysis_results/contextual_nearest_neighbors/llava_next")
