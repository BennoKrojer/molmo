#!/usr/bin/env python3
"""
Simple single-GPU contextual nearest neighbors across all layers.

WITH IMAGE PRELOADING - load all images directly to GPU once at start to avoid disk contention.
...
def main():
    ...
    for ctx_idx, ctx_layer in enumerate(ctx_layers):
        ...
        del cache_data  # Free CPU memory
