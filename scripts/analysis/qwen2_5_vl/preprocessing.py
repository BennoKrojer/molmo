#!/usr/bin/env python3
"""
Shared preprocessing for Qwen2.5-VL analysis and LLM judge.

CRITICAL: This module defines the SINGLE SOURCE OF TRUTH for Qwen2.5-VL image preprocessing.
...
- This matches Qwen2.5-VL's training preprocessing
"""
...
def preprocess_image_qwen2vl(
    ...
    """
    Preprocess image for Qwen2.5-VL using center-crop + resize.

    This is the CANONICAL preprocessing for Qwen2.5-VL across all scripts.
...
def get_expected_tokens(target_size: int = 448) -> int:
    """
    Calculate expected number of vision tokens for Qwen2.5-VL.

    Qwen2.5-VL: 14x14 patches with 2x2 spatial merger = 28 pixels per token
    ...
    Example:
        ...
        256  # 16x16 grid
    """
    # Qwen2.5-VL: 14x14 patches with 2x2 merger = 28 pixels per token
