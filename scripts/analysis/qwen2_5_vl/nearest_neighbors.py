#!/usr/bin/env python3
"""
Static Nearest Neighbor Analysis for Qwen2.5-VL Vision Tokens
...
Usage:
    CUDA_VISIBLE_DEVICES=0 python scripts/analysis/qwen2_vl/nearest_neighbors.py \
        --num-images 100 --layers "0,8,16,24,27" --output-dir analysis_results/nearest_neighbors/qwen2_5_vl
"""
...
def main():
    parser = argparse.ArgumentParser(description="Static NN for Qwen2.5-VL vision tokens")
    parser.add_argument("--model-name", type=str, default="Qwen/Qwen2.5-VL-32B-Instruct")
    parser.add_argument("--num-images", type=int, default=100)
    parser.add_argument("--split", type=str, default="validation")
    parser.add_argument("--output-dir", type=str, default="analysis_results/nearest_neighbors/qwen2_5_vl")
    ...
    print("=" * 70)
    print("QWEN2.5-VL STATIC NEAREST NEIGHBOR ANALYSIS")
    print("=" * 70)
    ...
    embed_tokens = model.model.language_model.embed_tokens.weight.data  # [vocab_size, hidden_dim]
