#!/usr/bin/env python3
"""
LatentLens (Contextual Nearest Neighbors) for Molmo-72B across all layers.

Uses the BASE CROP (12x12=144 tokens) for spatial analysis.

Usage:
    CUDA_VISIBLE_DEVICES=0 python scripts/analysis/molmo_72b/contextual_nearest_neighbors_allLayers_singleGPU.py \
        --contextual-dir molmo_data/contextual_llm_embeddings_vg/allenai_Molmo-72B-0924 \
...
def main():
    parser = argparse.ArgumentParser(description="LatentLens for Molmo-72B")
    parser.add_argument("--contextual-dir", type=str, required=True)
    parser.add_argument("--visual-layer", type=str, default="0,1,2,4,8,16,40,60,72,78,79")
    parser.add_argument("--num-images", type=int, default=100)
    parser.add_argument("--split", type=str, default="validation")
    parser.add_argument("--top-k", type=int, default=5)
    parser.add_argument("--output-dir", type=str,
                       default="analysis_results/contextual_nearest_neighbors/molmo_72b")
