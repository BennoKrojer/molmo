#!/usr/bin/env python3
"""
EmbeddingLens (Static Nearest Neighbor) Analysis for Molmo-72B Vision Tokens.
...
Usage:
    CUDA_VISIBLE_DEVICES=0 python scripts/analysis/molmo_72b/nearest_neighbors.py \
...
def main():
    parser = argparse.ArgumentParser(description="EmbeddingLens for Molmo-72B")
    parser.add_argument("--num-images", type=int, default=100)
    parser.add_argument("--split", type=str, default="validation")
    parser.add_argument("--output-dir", type=str,
                       default="analysis_results/nearest_neighbors/molmo_72b")
