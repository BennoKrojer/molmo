#!/usr/bin/env python3
"""
Shared preprocessing for Molmo-7B-D analysis and LLM judge.

CRITICAL: This module defines the SINGLE SOURCE OF TRUTH for Molmo-7B-D image preprocessing.
ALL scripts (NN, LogitLens, Contextual, LLM Judge, Viewer) MUST import from here.

Molmo-7B-D uses a multi-crop approach:
