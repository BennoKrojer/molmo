#!/usr/bin/env python3
"""
LogitLens Analysis for LLaVA-1.5-7B Vision Tokens.

Applies the LM head (ln_f + lm_head) to intermediate hidden states.

Usage:
    CUDA_VISIBLE_DEVICES=0 python scripts/analysis/llava_1_5/logitlens.py \
...
def main():
    parser = argparse.ArgumentParser(description="LogitLens for LLaVA-1.5-7B")
    parser.add_argument("--num-images", type=int, default=100)
    parser.add_argument("--split", type=str, default="validation")
    parser.add_argument("--output-dir", type=str,
                       default="analysis_results/logit_lens/llava_1_5")
