...
def main():
    ...
    with open("interp_data_contextual/data.json") as f:
        data = json.load(f)
    ...
    with open("llm_judge_results_contextual/human_study_llm_results.json") as f:
    ...
    with open("llm_judge_results_contextual/human_study_llm_results.json", 'w') as f:
